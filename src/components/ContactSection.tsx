...
const ContactSection = () => {
  ...
  return (
    <section id="contact" ref={sectionRef} className="py-20 bg-print-blue text-white">
      <div className="container-section">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          <form ref={formRef} onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              <label htmlFor="message" className="text-sm font-medium text-white/90">Project Details</label>
              <Textarea
                id="message"
                name="message"
            ...
            <Button 
              type="submit" 
              className="w-full bg-print-orange hover:bg-print-orange/90"
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-white/80">info@vividprint.com</p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-white/80">123 Print Avenue, Suite 101<br />Designville, CA 90210</p>
                  </div>
                </div>
              </div>
            </div>
